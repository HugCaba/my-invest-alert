...
def run_dca_mode():
    ...
    prompt = f"""
คุณคือ AI Robo-Advisor สำหรับ DCA ระยะยาว
...
โจทย์:
- วิเคราะห์ว่าควรเพิ่มอะไร หรือไม่ควรเพิ่มอะไร
- จัด Top 3 ที่ควรลงทุน
- แนะนำ 2 งบ:
  งบเบา 0–500 บาท
  งบหนัก 500–1000 บาท
- ให้จำนวนเงินแต่ละตัว
- เหตุผลสั้น ๆ

รูปแบบคำตอบ (สั้น กระชับ เหมาะกับมือถือ):
